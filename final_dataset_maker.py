...
for n in range(1,128):
    ...
    cell_array_64 = np.array([[10.2247 ,  0.     ,  0.     ],
           [-5.11235,  8.85485,  0.     ],
           [ 0.     ,  0.     , 23.3484 ]])
    ...
    if nat > 66:
        ...
        for i in range(len(atm_pos)):
            atm_pos[i] = [atm_pos[i][0],np.dot(cell_array_64,np.array(atm_pos[i][1:]))]
    ...
    for k,v in mid_N2_CN.items():
        ...
        if v < 3.0000:
                ...
                bader_charge = struct_64_charges_list[bader_charge_atom_index-1]
